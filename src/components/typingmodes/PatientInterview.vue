  ...
  <div class="app-container">
    ...
    <div class="main-section">
      ...
      <div class="timer-section">
        ...
        <span class="time-text">Patient Interview</span>
...
export default {
  ...
  data() {
    return {
      ...
      incorrect: 0,
      textToType:
        "Good morning, I’m your student nurse. What brings you in today? The patient reports dizziness since yesterday, worse when standing quickly. She denies chest pain, shortness of breath, or loss of consciousness. Medications include lisinopril and metformin; no known drug allergies. Diet has been inconsistent due to work schedule, and fluid intake is low. She sleeps five hours nightly and drinks two coffees daily. She recently increased exercise. The student assesses orthostatic vitals, reviews fall risks, and asks about vision changes, recent illness, or dehydration. Goals include hydration, balanced meals, and safer transitions from sitting to standing at home daily."
    };
  },
  computed: {
    progressWidth() {
