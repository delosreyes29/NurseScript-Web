  ...
  <div class="app-container">
    ...
    <div class="main-section">
      ...
      <div class="timer-section">
        ...
        <span class="time-text">Circulatory System</span>
...
export default {
  ...
  data() {
    return {
      ...
      incorrect: 0,
      textToType:
        "On assessment, capillary refill was under two seconds and skin warm and pink. Peripheral pulses palpable and equal bilaterally without edema. Blood pressure trended elevated, prompting lifestyle counseling. The nurse discussed sodium reduction, daily walking, stress management, and medication adherence. She reviewed warning signs of hypertensive urgency, including severe headache, chest pain, shortness of breath, or visual changes. Heart sounds S1 and S2 were regular with no murmurs, rubs, or gallops. The student reinforced home monitoring, logging readings, and bringing the cuff to appointments. Education included limiting alcohol, avoiding tobacco, and recognizing dizziness with position changes. Report swelling or palpitations."
    };
  },
  computed: {
    progressWidth() {
