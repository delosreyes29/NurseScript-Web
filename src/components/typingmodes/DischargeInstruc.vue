  ...
  <div class="app-container">
    ...
    <div class="main-section">
      ...
      <div class="timer-section">
        ...
        <span class="time-text">Discharge Instructions</span>
...
export default {
  ...
  data() {
    return {
      ...
      incorrect: 0,
      textToType:
        "You are being discharged home today. Continue taking medications exactly as prescribed. Call your provider for fever, chest pain, worsening shortness of breath, uncontrolled pain, or new swelling. Keep the incision clean and dry; change the dressing daily using clean technique. Do not lift heavy objects for two weeks. Walk short distances several times daily, increasing as tolerated. Drink water, eat balanced meals, and rest. Schedule a follow-up appointment within one week. Bring your medication list and questions. If redness spreads, drainage increases, or temperature exceeds one hundred point four, seek urgent care. Use the hotline for after-hours concerns immediately."
    };
  },
  computed: {
    progressWidth() {
