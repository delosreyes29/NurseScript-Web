  ...
  <div class="app-container">
    ...
    <div class="main-section">
      ...
      <div class="timer-section">
        ...
        <span class="time-text">Nursing Notes</span>
...
export default {
  ...
  data() {
    return {
      ...
      incorrect: 0,
      textToType:
        "0700: Received bedside report. Patient alert and oriented times three, resting comfortably. Lungs clear; respirations even and unlabored. Heart sounds regular. Abdomen soft, non-tender; bowel sounds active. IV saline lock patent. 0830: Administered morning medications as ordered; tolerated well. 1000: Assisted ambulation in hallway; steady gait with standby assist. 1130: Pain rated three of ten; provided heat pack and repositioning. 1200: Lunch tolerated; no nausea. 1300: Reinforced incentive spirometry; demonstrated correct technique. 1430: Assisted with toileting; output within expected range. 1600: Family at bedside; questions answered. 1700: Safety checks completed, call light within reach. Bed low, wheels locked, side rails."
    };
  },
  computed: {
    progressWidth() {
