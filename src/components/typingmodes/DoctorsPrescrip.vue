...
export default {
  ...
  data() {
    return {
      ...
      incorrect: 0,
      textToType:
        "Dr. Barnes prescribed amoxicillin-clavulanate 875 milligrams by mouth every twelve hours for seven days with food for acute bacterial sinusitis. Dispense fourteen tablets, zero refills. Advise completion of the full course even if symptoms improve. Monitor for rash, diarrhea, or signs of allergic reaction; seek urgent care for difficulty breathing or facial swelling. If severe nausea occurs, contact the clinic to discuss alternatives. Recommend saline irrigation, warm compresses, adequate fluids, and rest. Acetaminophen may be used as needed for fever or pain. Avoid decongestants if hypertension is uncontrolled. Schedule follow-up if no improvement within forty-eight hours. Call sooner for worsening."
    };
  },
  computed: {
    progressWidth() {
