  ...
  <div class="app-container">
    ...
    <div class="main-section">
      ...
      <div class="timer-section">
        ...
        <span class="time-text">Nervous System</span>
...
export default {
  ...
  data() {
    return {
      ...
      incorrect: 0,
      textToType:
        "The neurological assessment began with level of consciousness and orientation to person, place, time, and situation. Pupils were equal, round, and reactive to light and accommodation. Strength measured five out of five in all extremities. Sensation intact to light touch and pinprick. The patient denied headache, photophobia, or aura. Cranial nerves two through twelve grossly intact. Gait steady, negative Romberg, and no pronator drift. Reflexes two plus and symmetric. The nurse educated about stroke warning signs, FAST recognition, and calling emergency services immediately. She encouraged hydration, regular sleep, and medication adherence for migraine prevention, documenting findings clearly throughout the shift."
    };
  },
  computed: {
    progressWidth() {
