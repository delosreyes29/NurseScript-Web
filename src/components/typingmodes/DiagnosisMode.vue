...
.progress-circle { width: 30px; height: 30px; background-color: #004aad; border-radius: 50%; display: flex; align-items: center; justify-content: center; }
...
.customize-btn { color: white; background: #004aad; padding: 6px 12px; border-radius: 6px; }
