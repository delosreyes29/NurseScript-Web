  ...
  <div class="app-container">
    ...
    <div class="main-section">
      ...
      <div class="timer-section">
        ...
        <span class="time-text">Words</span>
...
export default {
  ...
  data() {
    return {
      ...
      incorrect: 0,
      textToType:
        "During the morning round, the nurse reviewed Mr. Santos's medication list carefully. She verified the MAR against the provider's orders, confirming metoprolol, enoxaparin, ceftriaxone, and sliding-scale insulin. Before administration, she assessed allergies, recent labs, and vital signs, noting a soft blood pressure and improved creatinine. She educated him about possible dizziness after metoprolol and bruising with enoxaparin. After scanning the barcodes, she administered medications safely, monitored for reactions, and documented effects. She reinforced timing with meals for insulin, encouraged hydration, and coordinated with pharmacy about a missing dose. She evaluated pain control, updated the plan, and reported progress during handoff."
    };
  },
  computed: {
    progressWidth() {
...
.space {
  /* no special styling needed; spaces will justify naturally */
}
